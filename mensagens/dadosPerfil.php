...
<body>
	<center><br><br>
		<div id="fotoIconContato" class="fotoIconContato" style="position:relative">
			...
			<div id="iconFoto" class="iconFoto" onMouseOver="javascrip:document.getElementById('iconFoto').style.opacity='1'" onMouseOut="javascrip:document.getElementById('iconFoto').style.opacity='0.5'" onClick="javascript:window.location.href='alteraFotoPerfilUsuario.php'">&blacktriangledown;</div>
